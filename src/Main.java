 ...
 * Handles menu navigation, manager login, and user interaction.
 */
public class Main {
    ...
    // Generate expiration dates for perishable items
    ...
    public static void main(String[] args) {
        ...
        // Outer loop to handle re-login after saving
        while (true) {
            ...
            while (true) {
                ...
                switch (choice) {
                    ...
                    case 1:
                        ...
                        // Record the product contribution
